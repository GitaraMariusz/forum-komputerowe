...
@section('content')
    <div class="container mx-auto py-8">
        <h1 class="text-4xl font-bold mb-4">Reported posts</h1>
        ...
        <div class="space-y-4">
            @foreach ($reportedPosts as $report)
                <div class="p-4 border border-gray-200 rounded-md">
                    ...
                    <p class="text-red-500 mt-2"><strong>Reason:</strong> {{ $report->reason }}</p>
                    ...
                    <form action="{{ route('admin.delete-report', $report->post->id) }}" method="POST" class="mt-4">
                        @csrf
                        @method('DELETE')
                        <button type="submit" class="bg-red-500 text-white px-4 py-2 rounded-md hover:bg-red-600">
                            Delete Report
